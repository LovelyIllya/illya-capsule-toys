...
<img src="\static\exampleImg\dai-chou-qu.png" alt="dai-chou-qu" style="width:200px;" /><img src="\static\exampleImg\chou-qu-zhong.png" alt="chou-qu-zhong" style="width:200px;" /><img src="\static\exampleImg\diao-luo.png" alt="diao-luo" style="width:200px;" /><img src="\static\exampleImg\wei-zhong-jiang.png" alt="wei-zhong-jiang" style="width:200px;" /><img src="\static\exampleImg\chou-qu-jie-guo.png" alt="chou-qu-jie-guo" style="width:200px;" /><img src="\static\exampleImg\bu-ke-chou-qu.png" alt="bu-ke-chou-qu" style="width:200px;" />
...
<template>
	<view class="content">
		<illyaCapsuleToys :giftImgList="giftImgList" :disabled="disabled" :resLv="resLv" :giftRes="giftRes" :resBallImg="resBallImg" @start="start" @canNotStart="canNotStart" @ok="ok" />
	</view>
</template>

<script>
	import illyaCapsuleToys from '../../components/illya-capsule-toys/illya-capsule-toys.vue';
	export default {
		components: {
			illyaCapsuleToys
		},
...
```html
<template>
	<illyaCapsuleToys  :resLv="resLv" :giftRes="giftRes" @start="start"  />
</template>
<script>
	data() {
        return {
...
```html
<template>
	<illyaCapsuleToys  :resLv="resLv" :giftRes="giftRes" @canNotStart="canNotStart"  />
</template>
<script>
	data() {
        return {
...
```html
<template>
	<illyaCapsuleToys  :resLv="resLv" :giftRes="giftRes" @ok="ok"  />
</template>
<script>
	data() {
        return {
